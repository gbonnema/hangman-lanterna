 ...
 * scrollbars. Through this interface the widget gives to the
...
public interface IScrollable {
	 ...
	 * 
	 * @return true, if the scrollbar is to be painted, false otherwise
	 */
	...
	/**
	 * The method returns colors, with which scrollbars are to be painted.
	 * 
