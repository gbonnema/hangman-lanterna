...
void fill_region(int aX, int aY, int aWide, int aHigh, jshort aNumber,
		jlong aAttr, chtype aCh) {
...
JNIEXPORT jint JNICALL Java_jcurses_system_Toolkit_getScreenWidth(JNIEnv * env,
		jclass class) {
	return COLS;
}

JNIEXPORT jint JNICALL Java_jcurses_system_Toolkit_getScreenHeight(JNIEnv * env,
		jclass class) {
	return LINES;
}
...
JNIEXPORT jint JNICALL Java_jcurses_system_Toolkit_computeChtype(JNIEnv * env,
		jclass class, jshort number) {
...
JNIEXPORT jint JNICALL Java_jcurses_system_Toolkit_readByte(JNIEnv * env,
	jclass class) {
